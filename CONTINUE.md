...
- Current `main` pin (2026-09-19): `a985f58044d0cc64600e2fb6c6d734c8b222f507` after PRs #35, #37–#52 (C4 guest limits, C5 walkthrough runner, B5/B6 hub and booking copy, C6 staff inbox capability, C7 guest ledger and kill switch, C8 `/health` build and switch state, A4 eval `--staff-inbox`, B7 try-page polish, C9/C10 session-row and usage-row retention; details in `docs/18-HANDOVER-INTEGRATOR.md` §2). Issue comments remain newer than this line. Live-host notes: `docs/20-OWNER-WALKTHROUGH-2026-09-18.md`.
