...
- Current `main` pin (2026-09-19): `7ab5a9d1bac6064d102ab61ed1a2c2749e66e101` after PRs #35, #37–#50 (C4 guest limits, C5 walkthrough runner, B5/B6 hub and booking copy, C6 staff inbox capability, C7 guest ledger and kill switch, C8 `/health` build and switch state, A4 eval `--staff-inbox`, B7 try-page polish, C9 session-row retention; details in `docs/18-HANDOVER-INTEGRATOR.md` §2). Issue comments remain newer than this line. Live-host notes: `docs/20-OWNER-WALKTHROUGH-2026-09-18.md`.
