...
| Piece | File | Status |
|---|---|---|
| Persona and rules | `prompts/rakan.system.md` (`rakan.system.v0.9`) | `proposal` — native-speaker and barber review NOT_RUN |
| Knowledge pack | `knowledge/build.mjs` → `knowledge/marsiya.v1.json` (47 records, revision 5) | built from `research/claude-20260913/` + the owner's answers; every record validates against `KnowledgeRecord` |
