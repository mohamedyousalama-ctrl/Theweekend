...
| Item | State |
|---|---|
| `main` = `3fb3d74` (2026-09-19) | Since `55c4c6b` (PRs #26–#34, #36, listed in the previous snapshot): **#35** (#8 walkthrough runner), **#37** (`/try` human chat), **#38** (public-guest opt-in), **#39** (B5 hub disclosure), **#41** (C5 walkthrough runner fixes), **#42** (B6 booking copy, prompt v0.9), **#40** (C4 guest limits, its commits folded into #44's merge) and **#44** (try-page Send) — merged by the owner's Cursor agent on 2026-09-18 20:23 UTC and audited afterwards (fixes landed in #45) — then **#43** (C6, 2026-09-18 21:27 UTC) and **#45** (C4/C7, 2026-09-19 01:19 UTC) merged by the integrator under D17 after the two-agent review. Full SHA in `CONTINUE.md` §5. |
...
| Bot reviews | Codex reviewed every PR marked ready through several rounds until its usage limit (2026-09-18 21:26 UTC); PR #43 `769a223` and PR #45 `7023618`–`0cd4065` were gated by the two-agent review only (recorded in both merge commits). CodeRabbit does not auto-review this repository (fewer than 10 stars). Cursor Bugbot: a comment whose text after `@cursor` starts with «review» triggers Bugbot and starts no Cursor agent — use `@cursor Apply …` (CONTINUE.md rules). |
