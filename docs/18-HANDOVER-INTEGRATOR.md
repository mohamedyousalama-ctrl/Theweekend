...
| Item | State |
|---|---|
| `main` = `3fb3d74` (2026-09-19) | Since `55c4c6b` (PRs #26–#34, #36, listed in the previous snapshot): **#35** (#8 walkthrough runner), **#37** (`/try` human chat), **#38** (public-guest opt-in), **#39** (B5 hub disclosure), **#41** (C5 walkthrough runner fixes), **#42** (B6 booking copy, prompt v0.9), **#40** (C4 guest limits) and **#44** (try-page Send) — the last two merged by the owner's Cursor agent on 2026-09-18 20:23 UTC and audited afterwards (fixes landed in #45) — then **#43** (C6) and **#45** (C4/C7) merged by the integrator under D17 on 2026-09-19 after the two-agent review. Full SHA in `CONTINUE.md` §5. |
